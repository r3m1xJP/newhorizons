...
namespace MedixCollege.Controllers
{
    public class ExternalController : Controller
    {
        ...
        public ActionResult GoogleAdwordsPPC()
        {
            return View();
        }

        public ActionResult GoogleAdwordsPPCPost(FormCollection fc)
        {
            PostData(fc, "New Lead - N2C GA");

            return View("GoogleAdwordsPPCThankYou");
        }
